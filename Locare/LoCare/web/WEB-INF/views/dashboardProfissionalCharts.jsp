<%-- 
    Document   : dashboardProfissionalCharts
    Created on : 10/09/2018, 22:49:06
    Author     : gabriel
--%>
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <h5 class="card-header">Estatísticas de suas atividades</h5>
                        <div class="card-body"></div>
                        <div class="card-footer small text-muted">Resultados com base em seu histórico.</div>
                    </div>
                </div> <!-- Container Fluid -->
