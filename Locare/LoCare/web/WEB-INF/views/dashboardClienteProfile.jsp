<%-- 
    Document   : dashboardClienteProfile
    Created on : 10/09/2018, 11:14:02
    Author     : gabriel
--%>
...
<!--                <li class="nav-item">
            ...
            <div id="content-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<c:url value="/updateSenha"/>" method="post">
                                <br/>  
                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#updateSenha">Alterar Senha</button>
                            </form>
                        </div>
                    </div>
                </div> <!-- Container Fluid -->
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <input type="password" name="senha" id="password" value="${pessoa.senha}" class="form-control input-lg" placeholder="Senha" tabindex="3" minlength="8" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="password" name="senha_confirmacao"  id="confirm_password" class="form-control input-lg" placeholder="Confirme sua senha" tabindex="4" minlength="8" required>
                                    </div>
                                </div>
                ...
                <form action="<c:url value="/deletePessoa"/>" method="post">
                    ...
                    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="logoutModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-secundary" data-dismiss="modal">Cancelar</button>
                                    <button type="submit" id="btn-confirm-2" class="btn btn-warning">Sair</button>
                                </div>
                            </div>
                        </div>
                    </div>
