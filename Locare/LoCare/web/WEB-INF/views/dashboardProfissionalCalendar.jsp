<%-- 
    Document   : dashboardProfissionalCalendar
    Created on : 10/09/2018, 22:41:05
    Author     : gabriel
--%>
...
<!--                <li class="nav-item">
            ...
            <div id="content-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <h5 class="card-header">Solicitações agendadas</h5>
                        <div class="card-body">

                            <div id="dp"></div>
                        </div>
                        <div class="card-footer small text-muted">Resultados com base em suas aprovações.</div>
                    </div>
                </div> <!-- Container Fluid -->
        ...
        <script>
            ...
            $('document').ready(function (){
               $.ajax({
                    url: '<c:url value="/getServicosProfissional"/>',
                    type: 'GET',
                ...
                function adicionarOrcamentos(){
                    for (var i = 0; i < servicos.length; i++) {
                        ...
                        var e = new DayPilot.Event({
                            ...
                            text: '' + servicos[i].solicitacaoOrcamento.contrantante.nome + ' - ' + servicos[i].solicitacaoOrcamento.contrantante.endereco + ''
                        });
                        dp.events.add(e);
