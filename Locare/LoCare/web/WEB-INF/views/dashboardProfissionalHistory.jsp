<%-- 
    Document   : dashboardProfissionalHistory
    Created on : 10/09/2018, 22:52:35
    Author     : gabriel
--%>
...
<!--                <li class="nav-item">
            ...
            <div id="content-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <h5 class="card-header">Seu histórico de atividades</h5>
        ...
        <script>
            ...
            $.ajax({
                url: '<c:url value="/getHistoricoProfissional"/>',
                type: 'GET',
            ...
            function adicionarHistorico(){
                for(var i = 0; i < historico.length; i++){
                    ...
                    $('#card-body').append('<div class="card">\n\
                                                <div class="card-header">' + historico[i].contrantante.nome + '</div>\n\
                                                <div class="card-body">\n\
                                                    <div class="form-row">\n\
                                                    ...
                                                    <div class="form-row">\n\
                                                        <div class="form-group col-md-12">\n\
                                                            <label for="recipient-formacao" class="col-form-label">Endereço do Contratante:</label>\n\
                                                            <input type="text" id="recipient-formacao" name="formacao" class="form-control" value="' + historico[i].contrantante.endereco + '" readonly />\n\
                                                        </div>\n\
                                                    </div>\n\
                                                    <div class="form-row">\n\
