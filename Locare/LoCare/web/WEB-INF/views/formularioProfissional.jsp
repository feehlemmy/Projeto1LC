        ...
        <div class="container align-self-center d-flex justify-content-center">
            <div class="container-fluid"id="box">
                <div class="card card-login mx-auto mt-5">
                    <div class="card-header">Cadastre-se para trabalhar</div>
                    <div class="card-body">
                        <form id="FormCadastro" role="form" method="post">
                            <div class="form-group">
                                <input type="text" name="nome" id="name" class="form-control input-lg" placeholder="Nome Completo" value="${profissional.nome}" tabindex="1">
                            </div>
                            <div class="form-group">
                                <input type="email" name="email" id="email" class="form-control input-lg" placeholder="Email" tabindex="2" value="${profissional.email}">
                            </div>

                            <div class="form-group">
                                <input type="password" name="senha" id="password" value="${profissional.senha}" class="form-control input-lg" placeholder="Senha" tabindex="3" required minlength="8">
                            </div>
